...
<div class="text-center" style="background-color: #D7C07C">
    ...
    <p class="p-style">
			...
			Most Adversaries focus on their advocacies and let other people handle the financial matters to them.
    </p>
    </div>
	<br>
</div>
...
<div class="container-subheading">
    <div class="container">
        ...
        <p class="p-style">
            ...
            <br>
            <strong>As THE ADVERSARY, here are the superpowers which you can focus on to build your first wealth base:</strong>
        </p>
        <br>
...
<div class="container-wealth-challenges">
    <div class="container">
        ...
        <h1 class="styled-text-title-wealth">A ADVERSARY</h1>
        ...
        {{-- <img src="{{ asset('assets/img/dashboard/Work.png') }}" alt="Image" draggable="false" class="cta-image-formula"> --}}
            ...
            <div class="styled-text-formula mt-2 text-center">
                <b>
                    ...
                    <br>
										Being More Knowledgeable About Financial Complexities
                </b>
            </div>
        <br> <br> <br> <br> 
    </div>
...
<div class="container-wealth-guide">
    <div class="container">
        ...
        <p class="p-style-guide">
								...
								<br>
								Listening to financial podcasts will make you think of the future. Nobody had ever foreseen that this COVID pandemic will shut down a lot of business &ndash; even those which were at the top of the ladder. Most people today need money for sustenance and comfortable living. Everyone is looking for a job to make money legally. You can learn how to achieve this perspective from people who have experienced being in the same scenario.
								<br>
