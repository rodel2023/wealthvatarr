			...
			<div class="tab-content" id="nav-tabContent">
				...
				<div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="nav-home-tab">
					<div class="row">
						<div class="col-12">
							<!-- Section Heading-->
							<h2 class="sub-header-capitalist text-center">
								WHAT MAKES YOU THE <span  class="text-danger"> <strong>CAPITALIST</strong> </span>
							</h2>
							<!-- Icon Divider-->
							...
							<p>You have your own set of approaches and practices when it comes to leadership and creativity. This makes you unstoppable once your creative mind generates another idea.</p>

							<p>In short, your earning capacity fuel your mind to think and envision new ideas.</p>
				...
				<div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="nav-superpowers-tab">
					<div class="row">	
						<div class="col-12">
							<!-- Section Heading-->
							<h2 class="sub-header-capitalist text-center">
								A <span  class="text-danger"> <strong>CAPITALIST'S</strong> </span> SUPERPOWERS							
							</h2>
							<!-- Icon Divider-->
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
				...
				<div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="nav-weaknesses-tab">
					<div class="row">
						<div class="col-12">
							<!-- Section Heading-->
							<h2 class="sub-header-capitalist text-center">
								A <span  class="text-danger"> <strong>CAPITALIST'S</strong> </span> WEAKNESSES
							</h2>
							<!-- Icon Divider-->
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
							...
							<p>A Capitalist does not really feel comfortable when they entrust a big project or a big deadline to people other than themselves. Their trust issues might have been rooted from their childhood or past relationship and friendship betrayals which led them to their fall.&nbsp;</p>

							<p>Capitalists cannot delegate significant work, because of this fear of sabotage. Besides, you think that your own creative ways can bring the best results and only you could do it the way you wanted it to be.</p>

							<h2 class="sub-header-capitalist text-center">
								You Are Obsessed With The Idea To Stay At The Top Of The Ladder
							</h2>

							<p>Money has always been a measure of success for a Capitalist. Money is a sign of accomplishment and at the same time a status symbol. It&rsquo;s a very big negative energy &ndash; because a Capitalist&rsquo;s idea might really be helpful, yet if they think it&rsquo;s not enough to generate enough money at the start, it is automatically dropped from the list.&nbsp;</p>

							<p>The biggest fear of a Capitalist is being taken that number one spot from them. They fear that they might be the next Nokia. They know that they always have to stay updated of the trends or they would be doomed forever.&nbsp;</p>

							<h2 class="sub-header-capitalist text-center">
								You Feel That You Don&rsquo;t Always Have Enough Time
							</h2>

							<p>Due to their ambitious nature, a Capitalist rarely has time for him/herself and their families. Frankly, they are the most disconnected from their friends and loved ones. Even if they do attend celebrations, their minds are filled with work-related matters.&nbsp;</p>

							<p>This big negative energy is brought about by a Capitalist&rsquo;s obsession with greatness and their fear to be surpassed by their competitors. They fear that they&rsquo;ll miss out a significant detail. For them, time is running and lots of wealth-generating opportunities will pass them by.&nbsp;</p>

							<p>A Capitalist fears that he would lose his financial stability and turn his efforts into a great waste.</p>
						</div>
				...
				<div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="nav-challenges-tab">
					<div class="row">	
						<div class="col-12">
							<h2 class="sub-header-capitalist text-center">
								WEALTH CHALLENGES FOR A <span  class="text-danger"> <strong>CAPITALIST</strong> </span> 						
							</h2>
							<!-- Icon Divider-->
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
							...
							<!-- Section Content-->
							<p>A highly creative mind paired with determination is a magic formula to instantly build your wealth. However, there are a lot of possible problems you are most possible to encounter.&nbsp;</p>
							...
							<ol>
								...
								<li style="list-style-type:decimal"><strong>You Have Troubles Building Genuine Relationships With Family, Friends, And Acquaintances</strong></li>
							...
							<p>As a general rule, a person under the age of 50 should see a doctor for a routine physical checkup once every 3 years. A person over the age of 50 should go at least once a year.&nbsp;</p>

							<p>An average doctor visit costs between $70-$250. Depending on the traffic and if you would rather opt for a walk-in visit, a doctor&rsquo;s visit would only take away 2 hours from your schedule.&nbsp;</p>
							...
							<p>The Capitalists lives for the future. The problem is, the future is uncertain. What is certain is today. Look at the things around you, aren&rsquo;t they the exact things you once wished when you were a kid?&nbsp;</p>
				...
				<div class="tab-pane fade" id="tab5" role="tabpanel" aria-labelledby="nav-wealth_formula-tab">
					<div class="row">	
						<div class="col-12">
							<h2 class="sub-header-capitalist text-center">
								A <span  class="text-danger"> <strong>CAPITALIST'S</strong> </span> WEALTH FORMULA 						
							</h2>
							<!-- Icon Divider-->
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
							...
							<h2 style="text-align:center"><strong>This is your power motivation formula in building your wealth as a Capitalist: </strong></h2>

							<h2  class = "text-danger" style="text-align:center"><strong>Self + Team Work + Relationships</strong></h2>

							<p>&nbsp;</p>

							<p class = "text-danger" style="text-align:center"><strong>And For Your Ultimate Secret to Wealth-Generation:</strong></p>

							<p class = "text-danger" style="text-align:center"><strong>Investing In Business And Life Coaching</strong></p>
						</div>
				...
				<div class="tab-pane fade" id="tab6" role="tabpanel" aria-labelledby="nav-wealth_guide-tab">
					<div class="row">
						<div class="col-12">
							<h2 class="sub-header-capitalist text-center">
								A <span  class="text-danger"> <strong>CAPITALIST'S</strong> </span> WEALTH GUIDE
							</h2>
							<!-- Icon Divider-->
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
							...
							<p><strong>Here are the solutions catered just for a Capitalist like you:</strong></p>

							<h2 class="sub-header-capitalist text-center">
								#1 Enlist The Help Of A Business Coach
							</h2>

							<p>Did you know that Bill Gates (Microsoft), Steve Jobs (Apple), and Eric Schmidt (Google) worked with a business coach to help expand their businesses? In fact, they credit their respective successes to their business mentors. If it weren&rsquo;t for them, there would not be Google, Apple, and Microsoft today.</p>
							...
							<p><strong>Where Can I Find The Best Business Coach?</strong></p>

							<ul>
								<li style="list-style-type:disc">Ask for referrals from friends and other entrepreneurs you know. If this is not possible, Google can help you find the best one for you. Avail a single session consultation with a prospect coach first, before availing their long-term services. Ask the business coach of their experience and track record, too.&nbsp;</li>
							</ul>
