...
<div class="container-subheading">
    <div class="container">
        ...
        <p class="p-style">
            ...
            <br>
            <strong>As THE INFLUENCER, here are the superpowers which you can focus on to build your first wealth base:</strong>
        </p>
        <br>
...
<div class="container-wealth-challenges">
    <div class="container">
        ...
        <h1 class="styled-text-title-wealth">A INFLUENCER</h1>
    ...
    <div class="cta-image-formula">
        {{-- <img src="{{ asset('assets/img/dashboard/Work.png') }}" alt="Image" draggable="false" class="cta-image-formula"> --}}
            <div class="styled-text-title-formula mt-5 line-spacing text-center">
                THE INFLUENCER'S WEALTH FORMULA
            </div>
            ...
            <div class="styled-text-formula mt-2 text-center">
                <b>
                    ...
                    <br>
										Finding Your Passion To Start Your Own Business
                </b>
            </div>
        <br> <br> <br> <br> 
    </div>
        ...
        <div class="decorative-border-guide text-center" style="background-color: #AF846D">
            <div class="styled-text-super line-spacing" style="margn-bottom: 0; color: #6D4B34">
				...
				<p class="p-style-guide">
					...
					<strong>Wages and salaries: 4.47 percent Interest: 4.24 percent</strong>
					<br>
					<strong>Dividends: 10.89 percent</strong>
					<br>
					<strong>Partnerships and corporations: 16.24 percent Capital gains: 65.16 percent</strong>
					<br>
					The top 400 earned more than half of their income from capital assets. These assets are investments &ndash; such as cars, stocks, houses, bonds, valuable pieces of arts, and other significant properties.
					<br>
					These only mean that living and working for a pure monthly income stream will not make you rich.
					<br>
