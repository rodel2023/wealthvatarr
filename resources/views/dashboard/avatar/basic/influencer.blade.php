			...
			<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="nav-home-tab">
					<div class="row">
						...
						<img src= "https://res.cloudinary.com/dohqthrfv/image/upload/v1649302378/WealthAvatarr/influencer1_vedqj0.png" class="img-intext" alt="" > 
						<p>
						...
						<p>
							Your social media accounts sure look like that of an influencer because of the expensive and
							beautiful things that you take photos of (and which you own). You love making good
							impressions and work hard to maintain it. Your charismatic personality indeed leaves a good
							impression on the people around you.
						</p>

						<p>
							The quote saying that “Happiness is buying yourself a present because you deserve it” appeals
							to you the most, among your friends and comrades.
						</p>
						<p>
							Your friends know you for being generous as well. They love getting along with your cheerful
						...
						<p>
							You being the most self-confident person in the room and your ability to radiate radiance even
							at the most dull events.
						</p>
						<p>
							Thanks to your cheerful personality and the things you own which screams class and grace,
							people trust that you can do a job easily.
						</p>
						<p>
							You tend to help people as well, because of the fact that it can and it will raise your status in the
							society.
						</p>
						<p>
							You appreciate opportunities. Hardly every best opportunity that comes knocking to you slip
							from yours hands. This is your magnet to good luck.
						</p>
						<p>
						...
						<p>
							Your ability to radiate confidence, authority and connections with people can help you generate
							income.
						</p>
						...
						<p>
							The last thing you worry about is being put on the center stage because you know your selfworth and you have a good way with words.
						</p>
						<p>
							This can be your sole energy and motivation to do a particular thing and grab that opportunity at
							the door.
						</p>
						<p>
							Influencers would rather worry about letting these good chances slip and take time preparing
						...
						<p>
							This secret of optimistic attitude of him and learning from the best people are some of the
							significant factors why his net worth grew tremendously.
						</p>
						<p>
				...
				<div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="nav-profile-tab">
					<div class="row">	
						<div class="col-12">
							...
							<p>
								You being dependent on other money for your happiness does more harm to you. Your desire
								to spend compulsively is unstoppable and you think no one can ever remedy this.
							</p>
							<img src= "https://res.cloudinary.com/dohqthrfv/image/upload/v1649302378/WealthAvatarr/influencer2_ddmjzd.png" class="img-intext" alt="" >
							<p>
								The reason for this is rooted in something that you are never expecting. In reality, the reason is
								more than the fact that these material stuff are something that will make your life comfortable.
								Caring a lot about material things is something that you should address right away.
							</p>
							<p>
								You find it hard to trust people to help you with insecurities. You are never okay sharing your
								problems with anyone but yourself.
							</p>
							
							<p>
								And this might be a reason why your own timeline to achieve your life goals is taking a little too
								long than expected.
							</p>
							<p>
								True enough, your social capabilities may seem fine. It can generate you income, and it can
								afford the lifestyle you want. But that is only for now, the world is changing and you have to
								muster the courage to get out of your comfort zone, particularly that reason why you have
								materialistic tendencies in the first place.
							</p> 
							<p>
							...
							<p>
								Influencers find it hard to let go of the material things that they think are making them happy.
							</p>
							<p>
							...
							<p>
								Your shine and self-confidence are not going to be there forever. Your bad money habits will put
								these natural gifts of yours into shame.
							</p>
							<p>
								Influencers are prone to suffer from lack of financial independence in the future because they
								failed to realize that they’ve been viewing life from a wrong perspective heading towards the
								wrong direction.
							</p>
							...
							<p>
								The first thing that mega-wealthy who found this revelation did was to become aware of
				...
				<div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="nav-contact-tab">
					<div class="row">
						<div class="col-12">
							...
							<img class="w-100" src="{{ asset('assets/img/image/analysis.png') }}">
							<p>
