...
<div class="container-wealth-challenges">
    <div class="container">
        ...
        <h1 class="styled-text-title-wealth">A BANKER</h1>
        ...
        {{-- <img src="{{ asset('assets/img/dashboard/Work.png') }}" alt="Image" draggable="false" class="cta-image-formula"> --}}
            ...
            <div class="styled-text-formula mt-2 text-center">
                <b>
                    ...
                    <br>
										Investing In Short-Term and Long-Term Assets
                </b>
            </div>
        <br> <br> <br> <br> 
    </div>
...
<div class="container-wealth-guide">
    <div class="container">
        ...
        <p class="p-style-guide">
				...
				<p class="p-style-guide"><strong>Why Short-Term Investments?</strong> </p>
        ...
        <p class="p-style-guide">
					A Banker is always hesitant to spend money on things they are not sure about. However, there are successful online businesses and side hustles which can be started with little to no capital at all!
					<br>
					<strong>
