    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">                 
                <img src="{{ asset('assets/img/dashboard/The Capitalist/superpower3-4.png') }}" alt="Your Image" class="img-fluid" style="height: 100%; width: auto">
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-9">
...
<div class="container-wealth-guide">
    <div class="container">
        ...
        <p class="p-style-guide">
            Then identify which category of expenses eats up your cash flows. adjust the other factors to increase your savings.
            <br>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <img src="{{ asset('assets/img/dashboard/The Capitalist/guide3.png') }}" alt="Your Image" class="img-fluid mt-4" style="height: 80%; width: auto;">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <img src="{{ asset('assets/img/dashboard/The Capitalist/guide3.png') }}" alt="Your Image" class="img-fluid mt-4" style="height: 100%; width: auto;">
            </div>
        </div>
        <br> <br> <br> <br>
