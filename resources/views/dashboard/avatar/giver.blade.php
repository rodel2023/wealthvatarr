    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="decorative-border text-center">
                ...
                <div class="styled-text-sub-title line-spacing" style="font-size: 1.7rem">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-7 text-center">
                ...
                <div class="decorative-border-weak text-center">
                    ...
                    <div class="styled-text-sub-title line-spacing" style="color: #6D4B34; font-size: 1.8rem">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-7 line-spacing text-center">
                ...
                <h1 class="styled-text-title-challeges">A GIVER</h1>
            </div>
            <div class="col-12 col-md-5">
