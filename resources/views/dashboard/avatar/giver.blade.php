			...
			<div class="tab-content" id="nav-tabContent">
					...
					<div class="row">
						<div class="col-12">
							...
							<h2 class="sub-header-giver text-center">
								WHAT MAKES YOU THE <span  class="text-danger"> <strong>GIVER</strong> </span>
							</h2>
							<!-- Icon Divider-->
				...
				<div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="nav-superpowers-tab">
					<div class="row">	
						<div class="col-12">
							<!-- Section Heading-->
							<h2 class="sub-header-giver text-center">
								A <span  class="text-danger"> <strong>GIVER'S</strong> </span> SUPERPOWERS							
							</h2>
							<!-- Icon Divider-->
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
				...
				<div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="nav-weaknesses-tab">
					<div class="row">
						<div class="col-12">
							<!-- Section Heading-->
							<h2 class="sub-header-giver text-center">
								A <span  class="text-danger"> <strong>GIVER'S</strong> </span> WEAKNESSES
							</h2>
							<!-- Icon Divider-->
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
				...
				<div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="nav-challenges-tab">
					<div class="row">	
						<div class="col-12">
							<h2 class="sub-header-giver text-center">
								WEALTH CHALLENGES FOR A <span  class="text-danger"> <strong>GIVER</strong> </span> 						
							</h2>
							<!-- Icon Divider-->
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
				...
				<div class="tab-pane fade" id="tab5" role="tabpanel" aria-labelledby="nav-wealth_formula-tab">
					<div class="row">	
						<div class="col-12">
							<h2 class="sub-header-giver text-center">
								A <span  class="text-danger"> <strong>GIVER'S</strong> </span> WEALTH FORMULA 						
							</h2>
							<!-- Icon Divider-->
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
				...
				<div class="tab-pane fade" id="tab6" role="tabpanel" aria-labelledby="nav-wealth_guide-tab">
					<div class="row">
						<div class="col-12">
							<h2 class="sub-header-giver text-center">
								A <span  class="text-danger"> <strong>GIVER'S</strong> </span> WEALTH GUIDE
							</h2>
							<!-- Icon Divider-->
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
