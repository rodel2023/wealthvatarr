	...
	<div class="container pt-2" style="background-color: white;">
      ...
      <div class="container-bg">
         ...
         <div class="row">
            ...
            <div class="col-sm-9 p-1 pb-2" style="background-color: #6C6C5F; color: #fff; border: 4px solid #454332;"> 
                  {{-- <h3 class="mt-5 me-5" style="font-weight: bold; margin-left: 3rem;">CONTENT:</h3> --}}
                  <p class="mt-5 me-5" style="font-size: 16px; margin: 0; padding: 0; margin-left: 3rem; margin-right: 3rem;">Your path to financial transformation and abundance! Are you ready to reset your mind for wealth attraction? In just 12 days, you’ll undergo a complete mental shift, breaking free from scarcity thinking and embracing a mindset of prosperity. Through daily exercises, affirmations, and guided meditations, you’ll reprogram your subconscious mind for financial success. Watch as opportunities align with your new wealth consciousness, propelling you towards financial abundance and fulfilment. The “12-Day Mind Reset Challenge” is your opportunity to reboot your relationship with money and align yourself with the flow of abundance. Get ready to upgrade your wealth blueprint  and step into a life of financial freedom and prosperity by accepting the challenge today!</p>
                  <div class="float-end me-5 mb-2">
