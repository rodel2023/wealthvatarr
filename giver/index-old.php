  ...
  <body>
	...
	<div class="hero-image">
		<div class="hero-text">
		  ...
		  <div class="giver-img">
			<img src="../public/assets/img/image/givermiddle.png" width="100px">
		  </div>
			...
			<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="nav-home-tab">
					<div class="row">
						...
						<img src= "https://res.cloudinary.com/dohqthrfv/image/upload/v1649299781/WealthAvatarr/giver1_pszd4c.png" class="img-intext" alt="" > 
						<p>
						...
						<h2 class="sub-header-giver text-center">
							Your personality and behavior are those of THE SALESPERSON
						</h2>
						...
						<p>
							The quote by Ioan Gruffudd saying that “As long as you understand that you find happiness
							through family, friends and love, then money is just a nice bonus.” appeals to you the most,
				...
				<div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="nav-profile-tab">
					<div class="row">	
						<div class="col-12">
							...
							<img src= "https://res.cloudinary.com/dohqthrfv/image/upload/v1649299696/WealthAvatarr/giver2_trgk1b.png" class="img-intext" alt="" >
							<p>
				...
				<div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="nav-contact-tab">
					<div class="row">
						<div class="col-12">
							...
							<img class="w-100" src="../public/assets/img/image/wealth_bundle2.png">
							<p>
...
<div id="footer">
	<div class="footer-logo">
		<!-- <span class="purple"><strong>Wealth</strong></span> <span class="pink">Archetypes</span> -->
