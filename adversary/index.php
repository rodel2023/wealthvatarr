	  ...
	  <div class="hero-image">
		<div class="hero-text">
		  ...
		  <div class="avatar-img">
			<img src="../public/assets/img/results/Adversary.png" width="180">
		  </div>
...
<div class="row my-row" id="tab-content-holder">
			...
			<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="nav-tab1-tab">
					<div class="row">
						...
						<p>
							You are one of the few people blessed with the <strong>best gifts</strong> not given to many. Your
							superpowers are there (in fact, you know you can feel it in you!) but they are currently
							dormant. There are endless possibilities given your <strong>unique set of gifts</strong> – which are just
							sitting and waiting for you to realize it.
						</p>
						<p>
							Just recently, things are getting tough on your part, isn’t it? Unfortunate circumstances
							have happened which have surely worn you out over the past weeks. Things didn’t go
							as planned. You spent time and effort and even sacrificed a lot but the results and the
							turn of events just...didn’t favor you.
						</p>
						<img src= "https://res.cloudinary.com/dohqthrfv/image/upload/v1649303567/WealthAvatarr/adversary1_khucrx.png" class="img-intext" alt="" > 
						<p>
							I hope you don’t lose your spark and let those greatest attributes I’ve seen in you die
							just because of these unfortunate incidents.
						</p>
						<p>
						...
						<p>
							This is the time where your greatest superpower – that set of gifts I’m talking about –
							will be of use to reveal even better things. Your natural gifts are product of your
							childhood dreams. These dreams include wealth, quality relationships, good luck, and
							happiness.
						</p>
						<p>
						...
						<h2 class="sub-header-avatar text-center">
							Your personality and behavior are those of THE ADVERSARY
						</h2>

						<p>
							If money and wealth is the main character of the show, you would be its adversary
							because you believe that it is the main cause of chaos, hence, you inherently feel
							disconnected about it.
						</p>

						<p>
							The quote saying that <i>“Money has never made man happy, nor will it, there is nothing
							in its nature to produce happiness. The more of it one has the more one wants.”</i> By
							Benjamin Franklin appeals to you the most, among your friends and comrades.
						</p>
						<p>
							You think that money is inherently evil. You avoid talking about it all the time. In fact,
							you are most likely to create and lead social movement to find genuine happiness
						...
						<p>
							Everyone likes you because of your leadership skills and personality and your ability to
							inspire that you stand out from the others. You have the best public speaking skills and
							when you speak, you see to it that people are persuaded by what you want to say.
						</p>
						<p>
							You care about social injustice and you listen to those who are victims of it. You lead
							people towards their own path to happiness and success.
						</p>
						<p>
							An Adversary is passionate about the things he loves. Adversaries have a lot of ideas in
							their mind. They initiate activities towards one goal. They can unite a group. That’s
							because you see the value of people and their unique skills.
						</p>
						<p>
							When it comes to wealth generation, this is a very good skill. Leaders who utilize other
							people’s potential know that every goal can be accomplished by team effort.
						</p>
						<p>
							An adversary knows how to do such. Big leaders can learn a lot from them!
						</p>

						<h2 class="sub-header-avatar text-center">
							Here’s an additional good news – you carry some sort of good luck thanks to this
								hidden strength of yours
						</h2>
						<p>
						...
						<p>
							In fact, you’ve got the right mindset and self-confidence skills to generate a lot of
							money.
						</p>
						<p>
						...
						<p>
							Mindset is a very powerful weapon that awakens your senses all the time. It’s the
							driving force to make changes and to turn around things in the most feasible way. It
							influences the way you behave and to rise immediately as soon as you fall.
						</p>
						<p>
							You radiate this mindset with other people. Your colleagues are secretly thanking you
							for this.
						</p>
						<p>
							The Adversaries have the potential to be the next big leader. They’ve got the skills and
							the right persuasion. They can influence people just by showing their confidence. They
							can make a huge impact inspiring others through their own example.
						</p>
						...
						<p>
							Mark Zuckerberg, Facebook CEO and the 5th richest man in the world, teaches the
							younger generations that the first step to success is to fix your mindset. If you want to
							start a company, ask yourself first what the problem is in the world that you want to
							solve and start from there.
						</p>
						<p>
							After all, that’s how Facebook started. This social innovation aimed to connect Harvard
							students using better communication facilities. It was started for the use of a small
							group only. Now, it has approximately 2 billion monthly users.
						</p>
						<p>
							Just like your personality type, his natural gift of developing such mindset made him one
				...
				<div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="nav-profile-tab">
					<div class="row">	
						<div class="col-12" id="step2">
							<h2 class="sub-header-avatar text-center">
							THESE WONDERFUL GIFTS, HOWEVER, ARE BEING COUNTERED BY YOUR
							GREATEST WEAKNESSES
							</h2>

							<p>
								Your strong emotions about money make it hard for you to proceed with your moneymaking goals. Your wealth generation ability still needs to be woken up or else, you
								would not be able to jumpstart your wealth journey.
							</p>
							<p>
								Whenever someone is talking about money, you’d think of all the excuses not to join or
								to gear the topic away from it.
							</p>
							<p>
								Lack of financial literacy is a dangerous thing!
							</p>
							<p>
								This makes you entrust everything to good luck or let other people handle your financial
								matters for you.
							</p>
							<img src= "https://res.cloudinary.com/dohqthrfv/image/upload/v1649303634/WealthAvatarr/adversary2_qlg791.png" class="img-intext" alt="" >
							<p>
								In fact, your debts are piling up due to lack of budget to stick with. You still depend on
								other people, financially.
							</p>
							<p>
								Your financial independence and happiness is something that’s far from reality.
							</p>
							<p>
								And that’s the reason you need to heed this advice.
							</p>
							<p>
								This is your greatest source of obstacles that constantly brings you problems with
								regards to wealth, relationships, and happiness.
							</p>
							<p>
								In fact, I’m seeing that this negative energy still continues as we go along so...
							</p>
							<h2 class="sub-header-avatar text-center">
								BEWARE OF THESE POTENTIAL PROBLEMS I’VE SEEN PEOPLE WITH SUCH
								WONDERFUL GIFTS HAVE ENCOUNTERED
							</h2>
							<p>
								The Adversaries find it hard to enjoy things and be contented in life. They often forget to
								appreciate money in the long run. They forgot that people, whether they like it or not,
								are fueled by their desire to live a comfortable life and money will significantly help with
								that.
							</p>
							<p>
								Adversaries are frustrated because they can’t fulfill their ideas and turn them to reality.
								They may focus on advocacies that their obligations to themselves are far from being
								fulfilled.
							</p>
							<p>
								For The Adversary, money is an uncomfortable topic. But unless they learn how to talk
								about it, their wealth generation journey will never come to fruition.
							</p>
							...
							<p>
								Your gifts are being utilized at its minimal. Your greatest weaknesses are slowly taking
								over your potential hence, achieving your goals are taking so much time for now.
							</p>
							<p>
								Your anxious mind makes it hard for you to find that happiness you’ve always yearned
								for in your career, lifestyle, relationships, and wealth.
							</p>
							<h2 class="sub-header-avatar text-center">
								Your timeline to achieve your goals are getting more and more extended because
								of this secret that wealthy people have since uncovered
							</h2>
				...
				<div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="nav-contact-tab">
					<div class="row">
						<div class="col-12" id="step3">
							...
							<img src= "https://res.cloudinary.com/dohqthrfv/image/upload/v1649314774/WealthAvatarr/sadperson_qserdb.png" class="img-intext mt-0" alt="">
							<p>
							...
							<div class="testimonial">
								...
								<p>I never knew I've been doing something wrong in my life, until my wealth archetype reading specifically pointed out this certain unconscious thing that's draining me day by day! 
									I never really intended to purchase the whole package because hey it's just the same as every other quiz on the internet.
									But I'm telling you now - this one surprisingly made an exact reading of my personality when they sent me the free version. 
